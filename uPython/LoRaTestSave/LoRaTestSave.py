# LoRaTestSave.py
# Code to test mac save coomand
# The DebugPrint() function works to allow output to console while connected to RN2483
...
def hw_init():
    ...
    pin12.write_digital(1) #Hold UART TX high
...
def DebugPrint(string):
    ...
    baud = b'\0\x55\r\n'
    uart.write(baud)
    RN2483_CheckResponse() # get ok response to autobaud
...
while True:
    ...
    RN2483_SendCommand("mac save\r\n")
#   RN2483_Reset()
    sleep(10000)
#    RN2483_SendCommand("mac join otaa\r\n")
#    response = RN2483_CheckResponse()
    RN2483_SendCommand("sys reset\r\n")
